...
- [ใบงานการทดลองที่ 1: การสร้างวงจรลอจิกพื้นฐาน](lab-1.md)
- [ใบงานการทดลองที่ 2: การสร้างวงจร Combinational](lab-2.md)
- [ใบงานการทดลองที่ 3: ความรู้พื้นฐานเกี่ยวกับ FPGA และ VHDL](lab-3.md)
- [ใบงานการทดลองที่ 4: วงจร Combinational บน FPGA](lab-4.md)
- [ใบงานการทดลองที่ 5: วงจร Sequential และ Counter](lab-5.md)
- [ใบงานการทดลองที่ 6: วงจร Arithmetic และ Seven-Segment](lab-6.md)
- [ใบงานการทดลองที่ 7: วงจรคำนวณทางคณิตศาสตร์บน FPGA](lab-7.md)
- [ใบงานการทดลองที่ 8: การบูรณาการระบบเครื่องคิดเลขด้วย VHDL](lab-8.md)
